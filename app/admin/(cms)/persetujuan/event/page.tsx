...
export default function PersetujuanEventPage() {
  ...
  return (
    <div className="space-y-6">
      <AdminPageHeader
        title="Persetujuan Event Mendatang"
        description="Daftar pengajuan agenda kegiatan dari Admin RW / Kampung KB yang memerlukan verifikasi Admin Kelurahan."
      />
      ...
      {loading ? (
        ...
        <div className="rounded-2xl border border-border bg-card p-12 text-center text-sm text-muted-foreground">
          Tidak ada pengajuan event yang menunggu persetujuan.
        </div>
      ) : (
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 border-b border-orange-200/80 pb-3">
                <div className="space-y-1">
                  ...
                  <p className="text-xs text-muted-foreground">📍 {item.lokasi} • 🗓️ {item.tanggal_mulai}</p>
                </div>

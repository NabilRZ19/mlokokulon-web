...
export default function TambahLayananPage() {
  ...
  const [kategori, setKategori] = useState("Administrasi Kependudukan");
  const [deskripsi, setDeskripsi] = useState("");
  const [waktuProses, setWaktuProses] = useState("1 Hari Kerja");
  const [biaya, setBiaya] = useState("Gratis (Rp 0)");
  const [kontakPenanggungJawab, setKontakPenanggungJawab] = useState("Kantor Kelurahan / Hotline");
  const [urutan, setUrutan] = useState(1);

  // Dynamic Array Input Persyaratan & Prosedur
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(data.error || "Gagal menambah layanan baru.");
      }
        ...
        <div className="rounded-xl border border-border bg-card p-6 shadow-sm space-y-5">
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Contoh: Akta Kelahiran, KK, dan KIA (Pelayanan 3 in 1)"
            ...
            <div>
              ...
              <input
                ...
                placeholder="Contoh: Administrasi Kependudukan / Surat Keterangan / Perizinan"
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Penjelasan mengenai manfaat dan ruang lingkup pelayanan publik ini…"
          ...
          <div className="grid grid-cols-3 gap-4">
            <div>
              ...
              <input
                ...
                placeholder="Contoh: 1 Hari Kerja / Langsung Jadi"
                className="w-full rounded-lg border border-border bg-card px-3.5 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40"
              />
            </div>
          ...
          <div>
            ...
            <input
              ...
              placeholder="Contoh: Kantor Kelurahan / Seksi Pelayanan Publik"
              className="w-full rounded-lg border border-border bg-card px-3.5 py-2.5 text-sm text-foreground focus:outline-none focus:ring-2 focus:ring-primary/40"
            />
          </div>

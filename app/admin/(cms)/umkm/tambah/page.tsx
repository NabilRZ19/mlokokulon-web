...
export default function TambahUmkmPage() {
  ...
  return (
    <div>
      <AdminPageHeader title="Tambah UMKM & Potensi" />

      <ApprovalNoticeBanner contentType="profil UMKM" />
        ...
        <div className="rounded-xl border border-border bg-card p-4 sm:p-6 shadow-sm space-y-5">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Ceritakan tentang usaha, keunggulan produk, atau bahan baku yang digunakan…"
          ...
          <div className="rounded-xl border border-primary/20 bg-primary/5 p-4 space-y-3">
            ...
            <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
              ...
              <div>
                <label htmlFor="jamBuka" className="mb-1 block text-xs font-semibold text-muted-foreground">
                  Jam Buka
                </label>
                <select
                  id="jamBuka"
              ...
              <div>
                <label htmlFor="jamTutup" className="mb-1 block text-xs font-semibold text-muted-foreground">
                  Jam Tutup
                </label>
                <select
                  id="jamTutup"
          ...
          <div>
            ...
            <p className="mb-2 text-xs text-muted-foreground">
              Foto per produk bersifat opsional. Kosongkan jika tidak diperlukan.
            </p>

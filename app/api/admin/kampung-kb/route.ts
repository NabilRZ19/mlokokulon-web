...
import { getKampungKbStoreAsync, saveKampungKbStoreAsync } from "@/lib/kampung-kb-store";
...
export async function GET() {
  ...
  const data = await getKampungKbStoreAsync();
...
export async function PUT(request: Request) {
  ...
  try {
    ...
    await saveKampungKbStoreAsync(body);

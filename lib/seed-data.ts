...
export const initialEventData = [
  {
    id: "event-1",
    judul: "Musyawarah Perencanaan Pembangunan Kelurahan (Musrenbangkel)",
    slug: "musrenbangkel-2026",
    deskripsi: "Musyawarah tahunan penyusunan rencana kerja pembangunan Kelurahan Mlokomanis Kulon yang melibatkanseluruh elemen pengurus RT, RW, tokoh masyarakat, dan lembaga kelurahan.",
    tanggalMulai: "2026-08-20",
    tanggalSelesai: "2026-08-20",
    jamMulai: "08:30 WIB - Selesai",
    lokasi: "Pendopo Kantor Kelurahan Mlokomanis Kulon",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
  ...
  {
    id: "event-2",
    judul: "Posyandu Balita & Posbindu PTM Serentak",
    slug: "posyandu-balita-dan-posbindu-serentak",
    deskripsi: "Pemeriksaan kesehatan gratis, penimbangan balita, pemberian makanan tambahan (PMT), dan cek gula darah/kolesterol bagi lansia.",
    tanggalMulai: "2026-08-25",
    tanggalSelesai: "2026-08-26",
    jamMulai: "08:00 WIB - 12:00 WIB",
    lokasi: "Balai RW 05 Pencil & Rumah Data Kampung KB",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
    penulis: "Kader Kesehatan Kampung KB",
    status: "published" as const,
    createdBy: "admin-1",
  },
  {
    id: "event-3",
    judul: "Pelatihan & Bazar Pendampingan UMKM Warga",
    slug: "pelatihan-dan-bazar-umkm-warga",
    deskripsi: "Pelatihan pemasaran digital, legalitas NIB, serta pameran produk unggulan warga Kelurahan Mlokomanis Kulon.",
    tanggalMulai: "2026-09-05",
    tanggalSelesai: "2026-09-07",
    jamMulai: "09:00 WIB - 16:00 WIB",
    lokasi: "Lapangan Kelurahan Mlokomanis Kulon",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
    penulis: "Tim Pendamping UMKM",
    status: "published" as const,
    createdBy: "admin-1",
  },
];

export const initialPengumumanData = [
  {
    id: "pengumuman-1",
    judul: "Jadwal Pelayanan Administrasi & Perekaman E-KTP Keliling",
    slug: "jadwal-pelayanan-administrasi-ektp-keliling",
    targetPengumuman: "Seluruh Warga Kelurahan",
    isi: "Diberitahukan kepada seluruh warga Kelurahan Mlokomanis Kulon bahwa Dinas Kependudukan dan Pencatatan Sipil bekerjasama dengan Kelurahan akan menyelenggarakan pelayanan perekaman E-KTP dan cetak Kartu Keluarga keliling di Pendopo Kelurahan.",
    tanggal: "2026-08-15",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
    penulis: "Seksi Pemerintahan Kelurahan",
    status: "published" as const,
    createdBy: "admin-1",
  },
  {
    id: "pengumuman-2",
    judul: "Batas Akhir Penyetoran Pajak Bumi dan Bangunan (PBB-P2) Tahun 2026",
    slug: "batas-akhir-penyetoran-pbb-p2-tahun-2026",
    targetPengumuman: "Wajib Pajak & Pemilik Lahan",
    isi: "Himbauan kepada seluruh wajib pajak di wilayah Kelurahan Mlokomanis Kulon untuk segera melakukan pelunasan PBB-P2 sebelum jatuh tempo 31 Agustus 2026 melalui Bank Jateng, Kantor Pos, atau Kas Dikit Pokja RW.",
    tanggal: "2026-08-10",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
    penulis: "Kolektor PBB Kelurahan",
    status: "published" as const,
    createdBy: "admin-1",
  },
  {
    id: "pengumuman-3",
    judul: "Kerja Bakti & Resik Desa Serentak Sambut Peringatan Kemerdekaan",
    slug: "kerja-bakti-resik-desa-serentak",
    targetPengumuman: "Ketua RT / RW & Seluruh Warga",
    isi: "Mengundang seluruh pengurus RT/RW dan warga masyarakat untuk melaksanakan kerja bakti pembersihan lingkungan, selokan, dan pemasangan bendera merah putih secara serentak di wilayah masing-masing.",
    tanggal: "2026-08-08",
    gambarCoverUrl: "/images/hero-kelurahan.jpg",
    penulis: "LPMK Mlokomanis Kulon",
    status: "published" as const,
    createdBy: "admin-1",
  },
];
